...
from Word import Definition, Word
...
class WordTest(unittest.TestCase):
    ...
    def test_valueObject(self):
        word1a = Word("word1", "", [Definition("noun", "meaning1", "")])
        word1b = Word("word1", "", [Definition("noun", "meaning1", "")])
        word2 = Word("word2", "", [Definition("noun", "meaning1", "")])
